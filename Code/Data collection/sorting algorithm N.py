...
for filename in files_t:
    if "csv" in filename:
        ...
        dest_path_t = os.path.join(r"C:\Users\GHB\Desktop\Screwcell dataset\Task data\N", filename)
...
for filename in files_e:
    if "wav" in filename:
        ...
        dest_path_e = os.path.join(r"C:\Users\GHB\Desktop\Screwcell dataset\Extrinsic data\N", filename)
        # Move the good screw files to N
...
for filename in files_i:
    if "csv" in filename:
        ...
        dest_path_i = os.path.join(r"C:\Users\GHB\Desktop\Screwcell dataset\Intrinsic data\N", filename)
        # Move the good screw files to N
