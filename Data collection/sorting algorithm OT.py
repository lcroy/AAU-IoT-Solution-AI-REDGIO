...
move_files(ut_s, taskdata_dir, r"C:\Users\GHB\Desktop\Screwcell dataset\Task data\UT")
...
for filename in files_t:
    if "csv" in filename:
        ...
        dest_path_t = os.path.join(r"C:\Users\GHB\Desktop\Screwcell dataset\Task data\OT", filename)
        # Move the over tightened files to OT
...
move_files(ut_s, extrinsic_dir, r"C:\Users\GHB\Desktop\Screwcell dataset\Extrinsic data\UT")
...
for filename in files_e:
    if "wav" in filename:
        ...
        dest_path_e = os.path.join(r"C:\Users\GHB\Desktop\Screwcell dataset\Extrinsic data\OT", filename)
        # Move the over tightened files to OT
...
move_files(ut_s, intrinsic_dir, r"C:\Users\GHB\Desktop\Screwcell dataset\Intrinsic data\UT")
...
for filename in files_i:
    if "csv" in filename:
        ...
        dest_path_i = os.path.join(r"C:\Users\GHB\Desktop\Screwcell dataset\Intrinsic data\OT", filename)
        # Move the over tightened files to OT
